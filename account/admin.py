...
class AccountAdmin(BaseUserAdmin):
    ...
    list_display = ('email', 'first_name', 'last_name', 'status', 'date_of_birth', 'is_staff', 'is_active', 'is_superuser','last_login','last_logout')
    list_filter = ('status',)
    readonly_fields = ('date_joined','last_login','last_logout')

    fieldsets = (
        
        ('Personal info', {'fields': ('email', 'first_name', 'last_name', 'status', 'country', 'date_of_birth', 'password')}),
